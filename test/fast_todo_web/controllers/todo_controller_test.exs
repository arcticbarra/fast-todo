defmodule FastTodoWeb.TodoControllerTest do
  use FastTodoWeb.ConnCase

  alias FastTodo.Lists
  alias FastTodo.Lists.Todo

  @create_attrs %{body: "some body", date: ~N[2010-04-17 14:00:00.000000], done: true}
  @update_attrs %{body: "some updated body", date: ~N[2011-05-18 15:01:01.000000], done: false}
  @invalid_attrs %{body: nil, date: nil, done: nil}

  def fixture(:todo) do
    {:ok, todo} = Lists.create_todo(@create_attrs)
    todo
  end
